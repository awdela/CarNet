...
//		super.setDefaultProperties();
	...
	public void show2(){
		...
		ObjectAnimator animator = ObjectAnimator.ofFloat(ButtonFloat.this, "y", this.getY(),this.getY()-100,this.getY());
		ObjectAnimator animator2 = ObjectAnimator.ofFloat(ButtonFloat.this,"alpha",0,1);
		animator.setInterpolator(new BounceInterpolator());
	...
	public void hide2(){
		...
		ObjectAnimator animator = ObjectAnimator.ofFloat(ButtonFloat.this,"alpha",1,0);
		animator.setDuration(1500);
		animator.start();
		isShow = false;
