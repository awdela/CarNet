...
import com.cumt.drawerlayout.carinfo.adapter.WeizhangResponseAdapter;
...
public class WeizhangResult extends Activity {
	 ...
	 * @return
	 */
	private List<WeizhangResponseHistoryJson> getData() {
		List<WeizhangResponseHistoryJson> list = new ArrayList<WeizhangResponseHistoryJson>();
